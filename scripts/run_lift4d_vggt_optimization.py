...
def _build_stage_loss_configs(motion_state_enabled, use_vggt_human_depth):
    ...
    stage_b_loss = {
        ...
        "palm_depth": {"weight": 30.0, "delta": 0.01, "terminal_weight": 100000.0, "terminal_frame": "contact", "phase": "precontact", "ramp_with_hand_ray": True},
        "palm_target_3d": {"weight": 5.0, "delta": 0.015, "terminal_weight": 10000.0, "terminal_frame": "contact", "phase": "precontact", "ramp_with_hand_ray": True},
        "palm_surface": {"weight": 100.0, "target_distance": 0.005, "delta": 0.005, "terminal_weight": 100.0, "terminal_frame": "contact", "phase": "precontact", "ramp_with_hand_ray": True},
...
def main() -> None:
    ...
    stages = [
        ...
        },
        {
            ...
            "overlap_frames": 5,
            "opt_vars": {
                "human_trans_res": {"lr": 0.0005, "frame_start": 0, "frame_ramp_end": 29},
