...
def _build_stage_loss_configs(motion_state_enabled, use_vggt_human_depth):
    ...
    stage_b_loss = {
        ...
        "palm_depth": {"weight": 30.0, "delta": 0.01, "terminal_weight": 0.0, "terminal_frame": "contact", "phase": "precontact", "ramp_with_hand_ray": True},
        "palm_target_3d": {"weight": 5.0, "delta": 0.015, "terminal_weight": 0.0, "terminal_frame": "contact", "phase": "precontact", "ramp_with_hand_ray": True},
        "palm_surface": {"weight": 100.0, "target_distance": 0.005, "delta": 0.005, "terminal_weight": 0.0, "terminal_frame": "contact", "phase": "precontact", "ramp_with_hand_ray": True},
