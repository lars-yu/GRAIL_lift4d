...
def preprocess_depth(
    ...
    Args:
        ...
        device: Device to run inference on
        depth_cfg: Optional keyword arguments forwarded to the depth estimator

    Returns:
        list: List of depth tensors for each frame
    """
    depth_cfg = depth_cfg or {}
    method = depth_cfg.get("method", "moge")
    print(f"Estimating depth for {len(image_list)} frames using {method}...")
